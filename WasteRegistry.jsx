...
export default function WasteRegistry() {
  ...
  function UnityComponent() {
    const { unityProvider, sendMessage, isLoaded } = useUnityContext({
      loaderUrl: "unityarreglado5/Build/unityarreglado5.loader.js",
      dataUrl: "unityarreglado5/Build/unityarreglado5.data",
      frameworkUrl: "unityarreglado5/Build/unityarreglado5.framework.js",
      codeUrl: "unityarreglado5/Build/unityarreglado5.wasm",
    });

    // Enviar valores actualizados a Unity
    useEffect(() => {
      if (isLoaded) {
        sendMessage("Visibilidad", "setContador", String(puntaje));
        sendMessage("Visibilidad", "setContadorCoche", String(coches));
      }
    }, [puntaje, coches, isLoaded]);
    ...
    <div className="waste-registry-screen">
      ...
      <div className="waste-registry-container">
        ...
        <div style={{ display: 'flex', gap: '20px', margin: '20px 0', justifyContent: 'center' }}>
          <button onClick={aumentarPuntaje}>Aumentar PuntajeOG</button>
          <button onClick={aumentarCoches}>Aumentar PuntajeOF2</button>
